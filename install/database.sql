...
CREATE TABLE `{prefix}basket` (
  ...
  `id_m` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ผู้สั่ง',
...
CREATE TABLE `{prefix}payment` (
  `payid` int(10) NOT NULL COMMENT 'ลำดับ',
  ...
  `id_m` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ผู้ชําระ'
